...
if ($_POST) {
    ...
    if (empty($jenis)) {
        echo "<script>alert('Jenis paket harus diisi');location.href='tambah_paket.php';</script>";
    } elseif (empty($harga)) {
        ...
        if ($insert) {
            echo "<script>alert('Sukses menambahkan paket');location.href='../template_show/tampil_paket.php';</script>";
        } else {
