  ...
  <div class="container">
    ...
    <form action="proses_ubah_detail_transaksi.php" method="post">
      ...
      <div class="mb-3">
        ...
        <div class="col-lg-12">
          <?php
          $arr_dibayar = array('belum_bayar' => 'Belum dibayar', 'dibayar' => 'Dibayar');
          ?>
          <select name="pembayaran" class="form-control">
            <?php foreach ($arr_dibayar as $key_dibayar => $val_dibayar) :
              if ($key_dibayar == $dt_transaksi['dibayar']) {
                $selek = "selected";
              // } elseif ($key_dibayar == $dt_transaksi['belum_bayar']) {
              //   $selek = "selected";
              } else {
                $selek = "";
              }
      ...
      <div class="mb-3">
        ...
        <div class="col-lg-12">
          <input type="text" class="form-control" id="val-email" name="qty" placeholder="Enter nama pelanggan.." value="<?= $data['qty'] ?>">
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="col-lg-8 ml-auto">
          ...
          <a href="../template_show/tampil_detail_transaksi.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
    </form>
  </div>
