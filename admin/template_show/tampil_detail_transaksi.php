            ...
            <tbody>
                ...
                <?php while ($data_member = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="fw-bold fs-6"><?= $data_member['jk'] ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="fw-bold fs-6"><?= $data_member['pembayaran'] ?></td>
                    </tr>
                    <tr>
            ...
            <tbody>
                ...
                while ($data_pembayaran = mysqli_fetch_array($qry_pembayaran)) {
                    ...
                    <tr class="text-xs font-weight-bold">
                        ...
                        <a class="btn btn-success" href="./ubah_detail_transaksi.php?id_transaksi=<?= $data_pembayaran['id_transaksi'] ?>">Edit</a></td>
                        </td>
                    </tr>
                <?php
                }
