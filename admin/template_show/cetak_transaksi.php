...
<body>
    ...
    <h2 class="tengah">LAPORAN TRANSAKSI LAUNDRY</h2>
    <h3 class="tengah">WashDry</h3>
    <p class="header">Email: washdry@gmail.com</p>
    <br>
    ...
    <ol style="text-align: justify">
        ...
        <li>Pengaduan harap disampaikan secara tertulis di ke email washdry@gmail.com dengan melampirkan nomor nota, video unboxing serta keluhan yang dialami.</li>
    </ol>
    <script>
        window.print();
    </script>
